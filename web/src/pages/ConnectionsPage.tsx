  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        {connections.map((c) => (
          <div key={c.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 flex flex-wrap items-start gap-2 sm:gap-4">
