    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 flex flex-col" style={{ maxHeight: '80vh' }}>
        ...
        <div className="flex items-center gap-1 px-4 py-2 border-b border-gray-100 text-xs overflow-x-auto whitespace-nowrap">
          <button onClick={() => navigate('/')} className="text-blue-600 hover:underline font-medium">/</button>
          {segments.map((seg, i) => {
            ...
            return (
              <span key={path} className="flex items-center gap-1">
                ...
                {isLast ? (
                  ...
                  <button onClick={() => navigate(path)} className="text-blue-600 hover:underline">{seg}</button>
                )}
              </span>
            )
          })}
